...
const mockupSpecPattern =
  /.*ui-(caring-contact-mockup|document-top-navigation-mockup|therapy-navigation-mockup|tools|tools-collapse|tools-search-mode-mockup|tools-task-directory)\.spec\.ts/;
