...
11. **Follow CI while it is useful, then stop**, per [Follow CI](../../docs/agents/pull-request-workflow.md#follow-ci). Never park a cron job or other open-ended watch on the PR.
