-- Ingestion concurrency hardening continuation (R17 + R5 sync).
--
-- This migration adds the partial unique index that prevents duplicate open jobs per
-- document (R17) and aligns worker metadata writes with a deep metadata merge in
-- commit/index repair paths (R5).
