-- Keep per-document lexical search on the document's committed index generation.
-- Legacy rows remain visible only while both the chunk and document generation are null.
