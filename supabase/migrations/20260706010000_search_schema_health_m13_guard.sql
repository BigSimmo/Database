-- Audit P2 M13: teach search_schema_health() to detect when the live DB is still
-- running the pre-20260702 commit_document_index_generation body that deleted
-- legacy NULL-generation artifacts unconditionally.
