...
| Committing as you go, and what to do when the pre-commit hook blocks you                                                  | [`docs/agents/commit-as-you-go.md`](docs/agents/commit-as-you-go.md)                         |
...
For why uncommitted work is the only work this repository loses, the commit-on-interruption rule,
and what to do when the pre-commit hook blocks you, see
[`docs/agents/commit-as-you-go.md`](docs/agents/commit-as-you-go.md).
