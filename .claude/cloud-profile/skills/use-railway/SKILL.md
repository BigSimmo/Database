...
|---------|---------------|
| `python3 ~/.claude/skills/use-railway/scripts/enable-pg-stats.py --service <name>` | Modifies shared_preload_libraries, may restart database |
| `python3 ~/.claude/skills/use-railway/scripts/pg-extensions.py --service <name> install <ext>` | Installs database extension |
| `python3 ~/.claude/skills/use-railway/scripts/pg-extensions.py --service <name> uninstall <ext>` | Removes database extension |
