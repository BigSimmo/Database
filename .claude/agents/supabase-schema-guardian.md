...
- **Fail-closed on null owner:** owner-scoped retrieval must refuse when the owner is null (privacy hardening, migration `20260708160001_retrieval_owner_matches_fail_closed`). Flag any change that would fail *open*.
