...
// Automatically captures all unhandled server-side request errors (Next.js 15+)
// for any request that reaches the Node.js runtime. This complements Next.js'
// own error boundaries.
