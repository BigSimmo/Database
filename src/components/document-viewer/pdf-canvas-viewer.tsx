    ...
    >
      {render ? (
        <canvas
          ...
          className={cn(
            "mx-auto max-w-full self-start rounded-lg bg-[color:var(--surface)] shadow-[var(--shadow-tight)] transition-opacity duration-[var(--duration-quick)] motion-reduce:transition-none",
