        ...
        className={cn(
          isDesktopHomeComposer
            ...
            : usesAnswerFooterStyle
              ? "floating-composer-edge dashboard-composer-edge fixed z-40 mx-auto max-w-3xl max-sm:bottom-0 sm:sticky sm:top-[calc(4.75rem+env(safe-area-inset-top))] sm:z-20 lg:max-w-4xl"
