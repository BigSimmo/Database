    ...
    <form onSubmit={handleFormSubmit} className={cn(panelSubtle, "p-3")}>
      ...
      {uploading && uploadPercent !== null && (
        <div className="mt-2" aria-hidden="false">
          ...
          >
            <div
              className="h-full w-full origin-left rounded-full bg-[color:var(--clinical-accent)] transition-transform duration-[var(--duration-moderate)] ease-[var(--ease-out)] motion-reduce:transition-none"
