...
export function ApplicationsLauncherWorkspace({
  ...
  // Standalone routes (e.g. /applications) render under the global search
  // shell, which shares its live composer query through this context.
  ...
  const query = controlledQuery ?? searchCommand?.query ?? "";
...
export function ApplicationsLauncherPage() {
  return <ApplicationsLauncherWorkspace desktopComposerSlotId={modeHomeDesktopComposerSlotId} />;
}
