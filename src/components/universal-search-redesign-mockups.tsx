...
=======
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              {
                title: "Radius",
                body: "Use rounded-lg for the search field — same as cards, buttons, and inline filters. Retire the full pill on search pages.",
              },
              {
                title: "Elevation",
                body: "Replace layered drop shadows with border + shadow-inset. Reserve elevation for menus and sheets only.",
              },
              {
                title: "Submit affordance",
                body: "Prefer a labelled Search button or soft accent icon — not a heavy floating circle that duplicates the magnifier.",
              },
              {
                title: "Width",
                body: "Match the content max-width or toolbar row. Avoid a narrow centred capsule when the page below is full-bleed.",
              },
            ].map((rule) => (
              <article
                key={rule.title}
