...
export const THERAPY_CATALOGUE_ASSETS = {
  full: "therapies.16552a934ddd9846.json",
  index: "therapies-index.efb2b0703a124d70.json",
} as const;
...
export const THERAPY_CATALOGUE_ASSETS_PREVIOUS = {
  full: "therapies.19fdb115f32ded8d.json",
  index: "therapies-index.3b89949314651253.json",
} as const;
...
export const THERAPY_CATALOGUE_SUMMARY = {
  ...
  defaultBriefSlug: "applied-relaxation-relaxation-based-therapy",
