...
export function ServiceDetailPage({ service }: { service: ServiceRecord }) {
  ...
  return (
    <main
      ...
      className="min-h-[calc(100dvh-4rem)] max-sm:shrink-0 bg-[color:var(--background)] px-3 py-4 pb-[calc(2rem+env(safe-area-inset-bottom))] text-[color:var(--text)] sm:px-5 sm:py-6 sm:pb-10 lg:px-8"
    >
