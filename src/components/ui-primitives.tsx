...
export const searchPageShell = "min-h-0 w-full flex-1 overflow-x-clip px-3 py-3 pb-4 sm:px-5 sm:py-5 sm:pb-8 lg:px-6";
...
export const searchPageShellStandalone =
  "min-h-0 w-full flex-1 overflow-x-clip px-3 pt-[max(0.75rem,var(--safe-area-top))] pb-4 sm:px-5 sm:pt-[max(1.25rem,var(--safe-area-top))] sm:pb-8 lg:px-6";
