...
const officialForms: OfficialForm[] = [
  ...
  { code: "1A attachment", title: "Information provided by another person in confidence", category: "Referral and detention" },
  { code: "1B", title: "Variation of referral", category: "Referral and detention" },
  { code: "2", title: "Order to detain voluntary inpatient in authorised hospital for assessment", category: "Referral and detention" },
  ...
  { code: "3C", title: "Continuation of detention to enable a further examination by a psychiatrist", category: "Referral and detention" },
  { code: "3D", title: "Order authorising reception and detention in an authorised hospital for further examination", category: "Referral and detention" },
  ...
  { code: "4E", title: "Approval of interstate transfer order", category: "Transport and transfer", availability: "unavailable" },
  ...
  { code: "5D", title: "Request made by a supervising psychiatrist for a practitioner to conduct the monthly examination of a patient", category: "Community treatment orders" },
  { code: "5E", title: "Notice and record of breach of Community Treatment Order", category: "Community treatment orders" },
  ...
  { code: "6B attachment", title: "Inpatient treatment order in a general hospital: report to Chief Psychiatrist", category: "Inpatient treatment orders" },
  ...
  { code: "9B", title: "Report to Chief Psychiatrist about provision of urgent non-psychiatric treatment", category: "Treatments" },
  ...
  { code: "10C", title: "Record of informing medical practitioner and treating psychiatrist of bodily restraint", category: "Restraint" },
  { code: "10D", title: "Record of observations made of restrained person", category: "Restraint" },
  { code: "10E", title: "Record of examination of restrained person and possible extension of bodily restraint", category: "Restraint" },
  ...
  { code: "11C", title: "Record of informing medical practitioner and treating psychiatrist of seclusion", category: "Seclusion" },
  { code: "11D", title: "Record of observations made of secluded person", category: "Seclusion" },
  { code: "11E", title: "Record of examination of secluded person and possible extension of seclusion", category: "Seclusion" },
  ...
  { code: "12B", title: "Record of refusal of patient’s request to access document", category: "Access to information and communication" },
  { code: "12C", title: "Restriction on freedom of communication", category: "Access to information and communication" },
  { code: "12C attachment", title: "Record of confirmation, amendment or revocation of restriction of freedom of communication", category: "Access to information and communication" },
...
const archiveGeneratedAt = text((formsCatalog as { exportMetadata?: { generatedAt?: unknown } }).exportMetadata?.generatedAt);
...
const pdfAssetByCode = new Map(
  formsPdfManifest.assets.map((asset) => [normalizeCode(asset.code), asset] as const),
);
...
function fallbackDetails(form: OfficialForm): Partial<FormCatalogDetails> {
  ...
  return {
    ...
    maker: "Only an appropriately authorised person under the Mental Health Act 2014 and the approved form instructions.",
    involved: "Confirm the required recipients, support persons, records and local PSOLIS workflow on the current approved form.",
    ...
    safetyPearl: "Open the current official source and confirm authority, timing, notices and filing requirements before completion.",
    preUseChecks: [
  ...
  return {
    ...
    contacts: [
      ...(details.officialPdfUrl
        ? [{ label: "Official public PDF", value: details.officialPdfUrl, detail: "Current OCP source", kind: "web" as const }]
        : []),
      { label: "Official forms register", value: details.officialRegisterUrl, detail: "Check current availability", kind: "web" },
    ],
    ...
    summaryCards: [
      ...
      { id: "source", label: "Source status", title: availabilityLabel, detail: `Official register checked ${officialFormsReviewedDate}` },
    ],
    ...
    tags: [...new Set([`Form ${details.form}`, details.category, "Mental Health Act 2014", ...details.aliases, ...details.searchTerms])],
