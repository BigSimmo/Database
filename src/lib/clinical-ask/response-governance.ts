 ...
 */
export function publicClinicalAskEvidence(items: readonly ClinicalAskEvidence[]): ClinicalAskEvidence[] {
...
function evidenceGap(
  ...
  return {
    ...
    missingInformation: [...new Set(safeAuxiliaryText(profile.id, missingInformation))],
