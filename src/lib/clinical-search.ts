...
/** Zone context patterns for query. */
...
/** Normalize query token for lookups. */
...
/** Normalized clinical query tokens. */
...
/** Has structured threshold evidence. */
...
/** Normalized clinical search tokens. */
