...
export function buildRetrievalQueryVariants(
  ...
  if (
    ...
    // chunk and did not reliably contribute candidates to the pool.
    // A "<colour> zone" variant retrieves the small, precise set of zone-action chunks
    // (escalation protocols, observation and response charts) that answer zone / next-step questions. Match the zone the
