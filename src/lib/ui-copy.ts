...
// not legal advice. See PIA-1 / PIA-5. The composer line is deliberately short so
// it reads as guidance, not a wall of text; the full detail lives on /privacy.
export const privacyCopy = {
  composerNotice: "Answers are generated by OpenAI in the US — don't enter identifiable patient details.",
