...
const entries: ClinicalVocabularyEntry[] = [
  ...
  { canonical: "clozapine", aliases: ["clozaril", "clozapin", "clozapinw", "clozapene"], type: "medication", weight: 1.3 },
  ...
  { canonical: "clozapine monitoring", aliases: ["clozapine monitering", "clozapin monitoring"], type: "workflow", weight: 1.2 },
