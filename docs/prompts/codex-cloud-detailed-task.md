...
3. Use the repository's installed Node 26/npm 11 toolchain and existing package lock. Do not switch package managers, loosen engines, add dependencies, or regenerate unrelated files unless the task demonstrably requires it.
