...
| `Open the Patient Plan`                                       | click   | navigation                    | none                                              | The person's own copy. **Added in Task 11** — before it the Patient Plan had no inbound link from anywhere outside its own pages            |
