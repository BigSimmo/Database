...
1. **Byte-faithful Docker-replay validation is required and Docker was down.** The established method
   (see [supabase-migration-reconciliation.md](../operations/supabase-migration-reconciliation.md) and the
...
[database-drift-detection.md](../operations/database-drift-detection.md#reconciliation-backlog).
