...
> [!IMPORTANT]
> **Superseded historical record.** The deferred registry-cleanup and public-title
> corrector work described below was later implemented in
...
> [deploy-corrector-public-titles.md](../operations/deploy-corrector-public-titles.md), and
> [operator-backlog.md](../plans/operator-backlog.md) instead.
