...
**Its name is settled: _Transport_.** _(`HD-Q1`, owner — reached this session as a relay.)_ The route
...
whoever owns them, and _"if a transport-officer view is ever wanted it is a view over the same jobs,
never a second place they live."_
...
> _"35 of 43 open movements have no transport job at all right now and are not listed below: there is
> no vehicle yet to track for them."_
