...
**Select a patient. The network answers one question: _where can this person go?_**
...
selected, **most of those digits stop being the point**: the card's job becomes _can this person go
here, and if not, why not_.
...
- ⚠️ **No ranking of wards.** Eligible wards **light; they do not sort by desirability.** The
  ...
  — **a "best match" ordering here would reintroduce both**: it ranks wards, and it ranks them _for
  this patient_.
