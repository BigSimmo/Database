...
- `/specifiers/[[...path]]` - Compatibility redirect to the corrected Formulation workspace. Source: `src/app/specifiers/[[...path]]/page.tsx`.
...
| Specifiers      | `/specifiers`        | `/specifiers?q=depressed+but+racing+thoughts&focus=1&run=1`           | Compatibility entry that redirects through `/specifiers` into the Formulation workspace.                                   |
