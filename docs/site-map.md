...
- `/mockups/settings-recommended-features` - Route discovered from app directory Source: `src/app/mockups/settings-recommended-features/page.tsx`.
- `/mockups/settings-recommended-features/[group]` - Route discovered from app directory Source: `src/app/mockups/settings-recommended-features/[group]/page.tsx`.
- `/mockups/settings-recommended-features/gallery` - Route discovered from app directory Source: `src/app/mockups/settings-recommended-features/gallery/page.tsx`.
