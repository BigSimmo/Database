...
- `/medications` - Medication index redirect. Source: `src/app/(search-app)/medications/page.tsx`.
...
| Medication      | `/medications`     | `/?mode=prescribing&q=acamprosate+renal+dose&focus=1&run=1`           | `/medications/[slug]`; `/medications` redirects to medication mode.                                                        |
