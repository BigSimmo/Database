...
- `/mockups/therapy-compass` - Route discovered from app directory Source: `src/app/mockups/therapy-compass/page.tsx`.
...
- `/applications` - Route discovered from app directory Source: `src/app/applications/route.ts`.
- `/auth/callback` - Route discovered from app directory Source: `src/app/auth/callback/route.ts`.
- `/differentials/presentations` - Route discovered from app directory Source: `src/app/differentials/presentations/route.ts`.
- `/medications` - Route discovered from app directory Source: `src/app/medications/route.ts`.
