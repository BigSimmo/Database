...
- `/differentials/compare` - Compare entry redirect into a presentation workflow or ad-hoc diagnosis comparison. Source: `src/app/(search-app)/differentials/compare/page.tsx`.
...
- `/differentials/compare` - Redirects to `/differentials/presentations/[workflow-slug]`. Source: `src/app/(search-app)/differentials/compare/page.tsx`.
