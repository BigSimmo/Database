...
- `/caring-contacts/patients` - The team's caring-contact caseload: one row per plan, filtered by plan state or synthetic identifier through the URL. Carries no patient-identifying detail. Source: `src/app/caring-contacts/patients/page.tsx`.
