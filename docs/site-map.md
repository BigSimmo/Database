...
- `/differentials/compare` - Selected differential diagnosis comparison. Source: `src/app/(search-app)/differentials/compare/page.tsx`.
...
| Differentials   | `/differentials` | `/differentials?q=acute+confusion&focus=1&run=1`                      | `/differentials/diagnoses`, `/differentials/diagnoses/[slug]`, `/differentials/compare`, and `/differentials/presentations`. |
