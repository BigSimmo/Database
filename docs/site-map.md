...
- `/dictionary/browse` - A–Z clinical term and abbreviation catalogue browser. Source: `src/app/(search-app)/dictionary/browse/page.tsx`.
...
- `/dictionary/search` - Source-linked clinical term and abbreviation search surface. Source: `src/app/(search-app)/dictionary/search/page.tsx`.
...
| Dictionary      | `/?mode=dictionary`      | `/dictionary/search?q=MSE&focus=1&run=1`                              | `/dictionary/search` is also a query-free browse surface; `/dictionary/browse`, `/topics`, `/topics/[slug]`, `/compare`, `/sources` and `/dictionary/[slug]` records.                     |
