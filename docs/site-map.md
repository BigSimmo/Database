...
- `/sources` - Sources catalogue home: the ranked clinical source catalogue and traceability entry point. Source: `src/app/(search-app)/sources/page.tsx`.
- `/sources/[sourceId]` - Source traceability detail: identity, rating, locations and application usage for one clinical source. Source: `src/app/(search-app)/sources/[sourceId]/page.tsx`.
- `/sources/method` - Sources rating method, limitations and status definitions. Source: `src/app/(search-app)/sources/method/page.tsx`.
- `/sources/publishers` - Publisher coverage across the clinical source catalogue. Source: `src/app/(search-app)/sources/publishers/page.tsx`.
- `/sources/topics` - Clinical source topics with filtered catalogue links. Source: `src/app/(search-app)/sources/topics/page.tsx`.
