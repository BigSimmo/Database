...
- `/applications` - Legacy application launcher redirect to Tools. Source: `src/app/applications/route.ts`.
...
- `/differentials/presentations` - Presentation workflow stream. Source: `src/app/differentials/presentations/route.ts`.
...
- `/medications` - Medication index redirect. Source: `src/app/medications/route.ts`.
