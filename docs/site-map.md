...
- `/ward-management/escalation` - One place showing every synthetic Ward Flow patient whose placement has gone wrong. Records and shows only. Source: `src/app/ward-management/escalation/page.tsx`.
...
- `/ward-management/handover` - Synthetic, point-in-time, printable shift handover, frozen at the moment it is opened. Source: `src/app/ward-management/handover/page.tsx`.
...
- `/ward-management/search` - Synthetic patient search — find an open Ward Flow movement by id, department, destination, stage or owner. Source: `src/app/ward-management/search/page.tsx`.
