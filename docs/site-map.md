...
| Factsheets      | `/?mode=factsheets`      | `/factsheets/search?q=sertraline&focus=1&run=1`                       | `/factsheets/topics` organises the library by category; `/factsheets/search` is the query-and-filter surface; `/factsheets/[slug]` records.                                                             |
