...
| Search hub                      | Wave 4 | [499827aa](https://claude.ai/code/artifact/499827aa-9ba4-4180-9001-325a1b094b4c) | **Done.** Third edition, `search-hub-third-edition.html`                                 | Rebuilt on this standard. The bar's universal search is the page's one composer and the directory panel carries no second field. The refusals of section 8.6 are kept word for word, and the nothing-found sentence names what this page searches. Two contrast pairs it reaches, ink and danger on accent-soft, were measured and added to section 3 first. Two gaps are reported below rather than closed on the page.                                                                                                           |
