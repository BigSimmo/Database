...
| OpenAI DPA / ZDR execution                 | ✅ executed | OpenAI account + legal               | OpenAI DPA v.010126 executed and project ZDR verified on 2026-08-18 (ledger #053). See [openai-cross-border-basis.md](openai-cross-border-basis.md).                                                                                       |
