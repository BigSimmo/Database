...
git status, recent commits, docs/guides/process-hardening.md,
...
- inspect package scripts, CI workflows, PR template, docs/guides/process-hardening.md,
  docs/clinical/clinical-governance.md, and relevant changed files
...
Before editing:
- inspect docs/clinical/clinical-governance.md
- inspect docs/guides/production-readiness-checklist.md
...
- docs/operations/retrieval-quality-runbook.md
...
- docs/security/rag-injection-threat-model.md
- docs/clinical/clinical-hazard-analysis.md
