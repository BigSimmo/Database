...
| `brace-expansion@5` `^5.0.9`                          | floor        | Same advisory on the 5.x line used by eslint-config-next, glob and readdir-glob. A `brace-expansion@2` entry was removed because the lock contains no 2.x copy.                                                                                                                  | When no dependant resolves a 5.x below the floor.                                          |
