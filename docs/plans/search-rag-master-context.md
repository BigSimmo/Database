...
- The historical 12000ms value in `docs/archive/search-rag-phase-0-baseline.md` and `docs/plans/search-rag-master-plan.md` records the Phase 7 rollout, not current guidance.
