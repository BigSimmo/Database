...
Curated map of `scripts/` (221 files) and the `package.json` script surface (234 entries),
...
| `check-installed-lock-parity.mjs`, `check-playwright-browser-revision.mjs`, `phone-chrome-plan.mjs`, `verify-phone-chrome.mjs`, `playwright-browser-preflight.mjs`, `playwright-pr-shards.mjs`                                                                          | Lock-trust preflight, container Chromium revision drift (#255), change-scoped phone contracts, Playwright browser-binary preflight before build, and duration-aware PR UI shard groups                                                                                                                                                                                                                                                                                                                        |
