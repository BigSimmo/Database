...
Curated map of `scripts/` (275 files) and the `package.json` script surface (275 entries),
...
| `check-node-engine.cjs`, `install-git-hooks.mjs`, `guard-push.mjs`, `guard-next-build.mjs`, `clean-next-build.mjs`                                                                                                                                                      | Install/preflight guards and path-safe `.next` cleanup                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
`check-agent-policy.mjs`, `check-outstanding-issues.mjs`, `check-pr-mergeability-workflow.mjs`,
