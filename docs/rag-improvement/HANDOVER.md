...
| S5         | B1+B2: telemetry assessment + offline harness                                                                                                         | `claude/rag-b1-b2-harness-<suffix>`              | —                     | Ready — dispatch now (S4 merged)                                                                          | —                                                                                                                                                                                                                                                                                           |
| S6         | B3: Docling lab benchmark                                                                                                                             | `claude/rag-b3-docling-lab-<suffix>`             | —                     | Ready — dispatch now (S4 merged)                                                                          | —                                                                                                                                                                                                                                                                                           |
