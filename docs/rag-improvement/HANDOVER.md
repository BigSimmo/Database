...
| S2         | A2 (+A3): composition menu + moderate length                                                                                                          | `claude/rag-a2-composition-<suffix>`             | —                     | Blocked on S1c + S1d (each merged with its own green canary pair)              | canary pair + `eval:answer-quality` + Gate E                                                                                                                                                                                                                                                                                                       |
