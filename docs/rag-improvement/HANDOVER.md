...
- **Landed 2026-08-17 (S1b, S1c, S1d, G1) — canary state 2026-08-18:** the S1c follow-up
  ...
  pair. **Do not reintroduce condition-first for/in binding.** S2 (A2 + A3) opened 2026-08-18:
  `src/lib/rag/answer-composition.ts`, prompt `clinical-rag-answer-v19`, `answerSections.maxItems`
  6, adversarial baseline re-captured for v19 (`baseline-record.md` §4).
...
| S3         | A4: follow-up suggestion refinement                                                                                                                   | `claude/rag-a4-follow-ups-<suffix>`              | —                     | Blocked on S2 merge + its green canary pair                                                                                     | consumes `buildRelatedInformationMenu` from `src/lib/rag/answer-composition.ts`                                                                                                                                                                                                                                                                                                                                                                                                                   |
