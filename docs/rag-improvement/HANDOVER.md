...
| S1       | A1 phase 2: evidence-chosen mitigation          | `claude/s1-rag-mitigation-231-86c182`            | #2022 | PR open — rung 1 verification-faithfulness fixes | 8 pre-fix + 5 post-fix live probes 2026-08-17; offline 583/583; rung-2 measurement in `docs/audit/live-drift-forensics-2026-08.md` §5 |
