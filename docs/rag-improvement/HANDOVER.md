...
| S2         | A2 (+A3): composition menu + moderate length                                                                                                          | `claude/rag-a2-composition-<suffix>`             | —                     | Blocked on the confirmation canary after PR #2088 (revert of #2065) merges; then dispatch                                 | canary pair + `eval:answer-quality` + Gate E                                                                                                                                                                                                                                                                                                       |
