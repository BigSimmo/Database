...
| Checkbox/RadioGroup          | all four closed. Two rows were stale when re-measured on 2026-08-08: ids already sanitise through `optionId`, and the group already carries `hint`/`error`/`describedBy`. Raw dimensions moved to `size-4.5`/`h-0.5`                                                                                    | **done**             |
...
| `Button`                 | controls | yes   | yes                | inherited-global-root | yes            | no                 |               1 |
