...
| `ConfirmDialog`          | layout   | yes   | yes                | inherited-global-root | yes            | no                 |               5 |
...
| `InlineNotice`           | feedback | yes   | yes                | inherited-global-root | yes            | no                 |              29 |
...
| `Select`                 | controls | yes   | yes                | inherited-global-root | yes            | no                 |               5 |
...
| `TextField`              | controls | yes   | yes                | inherited-global-root | yes            | no                 |              14 |
