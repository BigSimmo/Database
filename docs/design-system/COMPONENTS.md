...
| ------------------------ | -------- | ----- | ------------------ | --------------------- | -------------- | ------------------ | --------------: |
| `AccessibleTable`        | source   | yes   | yes                | inherited-global-root | yes            | yes                |               4 |
| `AnswerCard`             | answer   | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
| `AnswerFooter`           | answer   | yes   | yes                | no                    | yes            | yes                |               0 |
| `AsyncButton`            | controls | yes   | yes                | inherited-global-root | yes            | yes                |               4 |
| `Breadcrumb`             | layout   | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
| `Button`                 | controls | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
| `Checkbox`               | controls | yes   | yes                | no                    | yes            | yes                |               0 |
| `Chip`                   | controls | yes   | yes                | inherited-global-root | yes            | yes                |               3 |
| `Citation`               | source   | yes   | yes                | no                    | yes            | yes                |               0 |
| `CitationList`           | source   | yes   | yes                | no                    | yes            | yes                |               0 |
| `ConfirmDialog`          | layout   | yes   | yes                | no                    | yes            | yes                |               0 |
| `DateDisplay`            | source   | yes   | yes                | inherited-global-root | yes            | yes                |               3 |
| `Disclosure`             | layout   | yes   | yes                | no                    | yes            | yes                |               0 |
| `DisclosureGroup`        | layout   | yes   | yes                | no                    | yes            | yes                |               0 |
| `DoseLine`               | answer   | yes   | yes                | no                    | yes            | yes                |               0 |
| `DownloadLink`           | controls | yes   | yes                | no                    | yes            | yes                |               0 |
| `EmptyState`             | feedback | yes   | yes                | inherited-global-root | yes            | yes                |              12 |
| `ErrorSummary`           | feedback | yes   | yes                | no                    | yes            | yes                |               0 |
| `ExternalTextLink`       | controls | yes   | yes                | no                    | yes            | yes                |               0 |
| `FieldError`             | feedback | yes   | yes                | no                    | yes            | yes                |               0 |
| `FieldHint`              | feedback | yes   | yes                | no                    | yes            | yes                |               0 |
| `FormField`              | controls | yes   | yes                | inherited-global-root | yes            | yes                |               2 |
| `IconButton`             | controls | yes   | yes                | inherited-global-root | yes            | yes                |               2 |
| `InlineNotice`           | feedback | yes   | yes                | inherited-global-root | yes            | yes                |               6 |
| `LinkAction`             | controls | yes   | yes                | no                    | yes            | yes                |               0 |
| `LoadingPanel`           | feedback | yes   | yes                | inherited-global-root | yes            | yes                |               7 |
| `MissingValue`           | feedback | yes   | yes                | inherited-global-root | yes            | yes                |               3 |
| `OverlayRoot`            | layout   | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
| `PageHeader`             | layout   | yes   | yes                | inherited-global-root | yes            | yes                |               2 |
| `Pagination`             | controls | yes   | yes                | no                    | yes            | yes                |               0 |
| `PanelHeading`           | layout   | yes   | yes                | inherited-global-root | yes            | yes                |               2 |
| `Progress`               | feedback | yes   | yes                | no                    | yes            | yes                |               0 |
| `Quantity`               | answer   | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
| `RadioGroup`             | controls | yes   | yes                | no                    | yes            | yes                |               0 |
| `RetrievalStateBanner`   | answer   | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
| `SafeBoldText`           | layout   | yes   | yes                | inherited-global-root | yes            | yes                |               8 |
| `SearchField`            | controls | yes   | yes                | no                    | yes            | yes                |               0 |
| `SegmentedControl`       | controls | yes   | yes                | inherited-global-root | yes            | yes                |               2 |
| `Select`                 | controls | yes   | yes                | inherited-global-root | yes            | yes                |               2 |
| `Sheet`                  | layout   | yes   | yes                | inherited-global-root | yes            | yes                |              21 |
| `Skeleton`               | feedback | yes   | yes                | inherited-global-root | yes            | yes                |               6 |
| `SourceDesignationBadge` | source   | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
| `SourceProvenance`       | source   | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
| `SourceStatusBadge`      | source   | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
| `StageList`              | feedback | yes   | yes                | no                    | yes            | yes                |               0 |
| `StatusMark`             | source   | yes   | yes                | inherited-global-root | yes            | yes                |               2 |
| `Tabs`                   | controls | yes   | yes                | no                    | yes            | yes                |               0 |
| `TextField`              | controls | yes   | yes                | inherited-global-root | yes            | yes                |               3 |
| `TextLink`               | controls | yes   | yes                | no                    | yes            | yes                |               0 |
| `ToastRegion`            | feedback | yes   | yes                | no                    | yes            | yes                |               0 |
| `ToggleSwitch`           | controls | yes   | yes                | inherited-global-root | yes            | yes                |               2 |
| `Tooltip`                | feedback | yes   | yes                | no                    | yes            | yes                |               0 |
| `VerificationNotice`     | answer   | yes   | yes                | inherited-global-root | yes            | yes                |               1 |
