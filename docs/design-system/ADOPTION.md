...
Declared product roots: 83
Roots with a literal `.ckb-v2` opt-in: 1
Roots inheriting `.ckb-v2` from the global `<html>`: 82
...
| `caring-contacts-workspace`        | owned           |      9 |     9 | v2             | v2 (inherited-global-root) | passed         | not-committed  |
