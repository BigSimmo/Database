...
Declared product roots: 112
Roots with a literal `.ckb-v2` opt-in: 1
Roots inheriting `.ckb-v2` from the global `<html>`: 111
Production surfaces observed under v2: 14/14
Dynamic `ckb-v2` constructions: 0
Declared production page routes: 104/104
...
| `catalogues-forms-and-info`        | owned           |     61 |    61 | v2             | v2 (inherited-global-root) | passed         | not-committed  |
