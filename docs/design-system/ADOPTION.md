...
Declared product roots: 100
Roots with a literal `.ckb-v2` opt-in: 1
Roots inheriting `.ckb-v2` from the global `<html>`: 99
Production surfaces observed under v2: 17/17
Dynamic `ckb-v2` constructions: 0
Declared production page routes: 85/85
...
| `caring-contacts-workspace`                     | owned           |      7 |     7 | v2             | v2 (inherited-global-root) | passed         | not-committed  |
