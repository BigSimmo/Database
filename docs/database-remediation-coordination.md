...
**Ledger state note (2026-08-18):** pending inbox on `main`: `1591ee4a` (`#316`, Phase 1.2) plus six
unrelated requests; #2093 carries the `#056` update (`d958d671`, replacing cancelled `a1c319d6`).
One serialized `issues:reconcile` after #2093 lands. Never merge `main` into a PR carrying a
reconciliation.
