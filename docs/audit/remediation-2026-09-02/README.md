...
| P7 Scripts, test safety, ledger tooling | `claude/audit-fix-p7` | 11 | **pass** (recovered) — 10 fixed, 5 skipped | not run | none | Run gate, open PR. Owner decisions and skips: results/p7.json. |
| P8a CI workflows & supply chain (incl. browserslist update) | `claude/audit-fix-p8a` | 13 | implementer complete (recovered); reviewer did not finish — 13 fixed, 2 skipped | not run | none | Run an adversarial review, then gate and PR. Owner decisions and skips: results/p8a.json. |
...
| P9 Agent tooling & permissions | `claude/audit-fix-p9` | 7 | **pass** (recovered) — 7 fixed, 2 skipped | not run | none | Run gate, open PR. Owner decisions and skips: results/p9.json. |
| P10 Privacy & governance documents | `claude/audit-fix-p10` | 6 | implementer complete (recovered); reviewer did not finish — 6 fixed, 2 skipped | not run | none | Run an adversarial review, then gate and PR. Owner decisions and skips: results/p10.json. |
...
| P13 Sandboxes & UI tidy-ups | `claude/audit-fix-p13` | 6 | implementer complete (recovered); reviewer did not finish — 7 fixed, 1 skipped | not run | none | Run an adversarial review, then gate and PR. Owner decisions and skips: results/p13.json. |
