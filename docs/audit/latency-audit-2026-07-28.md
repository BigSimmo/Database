...
| ------------ | --------------------------------------------------- | -------------------------------------------------------------- |
| **free**     | L1-2, L2-6, L2-9, L3-4, L3-5                        | Ordinary review — all applied                                  |
...
| L1-2        | Scope overlapped with the rate-limit RPC, abort-on-deny, signal threaded                             | `src/app/api/answer/route.ts`, `tests/answer-route-preamble.test.ts`                                                           |
