...
Do not run retrieval or RAG evals when this reports `supabase_unavailable`, read errors, or a partially recovered indexing queue. Follow `docs/operations/reindex-runbook.md` first.
