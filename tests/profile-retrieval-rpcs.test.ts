...
describe("retrieval RPC profiler redaction", () => {
  it("redacts credentials, emails, and UUIDs from persisted text", () => {
    const text = sanitizeProfileText(
      "operator@example.test owner 11111111-1111-4111-8111-111111111111 Authorization: Bearer abcdefghijklmnop password=hunter2 token=opaquevalue credential:opaquevalue",
    );
