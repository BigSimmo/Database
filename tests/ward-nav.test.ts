...
const WARD_DYNAMIC_ROUTE_ORPHANS: ReadonlyMap<string, string> = new Map([
  ...
  [
    ...
    "0 of 65 instances reachable without state — and this is a limit of a source scan, not an orphan " +
  ...
  [
    ...
    "0 of 23 instances reachable without state — and unlike every other entry here, this one records " +
  ...
  [
    ...
    "0 of 8 instances reachable without state — the same scan limit as the ward detail route above, " +
