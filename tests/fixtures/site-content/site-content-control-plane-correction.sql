...
insert into public.site_content_releases (
  ...
  '91ceaa8d-470c-5661-8ce6-980c2a1bb137'::uuid,'control-plane-fixture-v1',repeat('1',64),
...
with fields as (
  select jsonb_build_object(
    ...
    'resource',jsonb_build_object(
      ...
      'previousSiteReleaseId','91ceaa8d-470c-5661-8ce6-980c2a1bb137',
      'previousSiteReleaseDigest',bootstrap.release_digest)
  ) receipt
  from public.site_content_releases bootstrap
  where bootstrap.id = '91ceaa8d-470c-5661-8ce6-980c2a1bb137'::uuid
), complete as (
...
where id = '91ceaa8d-470c-5661-8ce6-980c2a1bb137'::uuid;
...
begin
  with activation as (
    ...
    select jsonb_build_object(
      ...
      'target',jsonb_build_object(
        'kind','site_release','siteReleaseId','91ceaa8d-470c-5661-8ce6-980c2a1bb137',
  ...
  if not public.rollback_site_content_release(
    ...
    '91ceaa8d-470c-5661-8ce6-980c2a1bb137'::uuid,
    repeat('6',64),
    v_receipt
  ) then
...
begin
  ...
  if v_health->>'publicSiteChangeEpoch' <> '1'
    ...
    or v_health->'activePublicSiteRelease'->>'releaseId' <> '91ceaa8d-470c-5661-8ce6-980c2a1bb137' then
...
with source as (
  ...
  where rr.release_id = '91ceaa8d-470c-5661-8ce6-980c2a1bb137'::uuid
