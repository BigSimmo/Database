...
insert into public.site_content_releases (
  ...
  'ddc94ecf-3527-5b4d-846b-af5724b428ca'::uuid,'control-plane-fixture-v1',repeat('1',64),
...
with fields as (
  select jsonb_build_object(
    ...
    'resource',jsonb_build_object(
      ...
      'previousSiteReleaseId','ddc94ecf-3527-5b4d-846b-af5724b428ca',
      'previousSiteReleaseDigest',bootstrap.release_digest)
  ) receipt
  from public.site_content_releases bootstrap
  where bootstrap.id = 'ddc94ecf-3527-5b4d-846b-af5724b428ca'::uuid
), complete as (
...
where id = 'ddc94ecf-3527-5b4d-846b-af5724b428ca'::uuid;
...
begin
  with activation as (
    ...
    select jsonb_build_object(
      ...
      'target',jsonb_build_object(
        'kind','site_release','siteReleaseId','ddc94ecf-3527-5b4d-846b-af5724b428ca',
  ...
  if not public.rollback_site_content_release(
    ...
    'ddc94ecf-3527-5b4d-846b-af5724b428ca'::uuid,
    repeat('6',64),
    v_receipt
  ) then
...
begin
  ...
  if v_health->>'publicSiteChangeEpoch' <> '1'
    ...
    or v_health->'activePublicSiteRelease'->>'releaseId' <> 'ddc94ecf-3527-5b4d-846b-af5724b428ca' then
...
with source as (
  ...
  where rr.release_id = 'ddc94ecf-3527-5b4d-846b-af5724b428ca'::uuid
