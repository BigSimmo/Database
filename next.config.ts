        ...
        headers: [
          { key: "Cache-Control", value: "public, max-age=0, must-revalidate" },
          {
            ...
            value:
              ...
              `default-src 'none'; script-src 'sha256-BeUejUa5abhM/9BoB9+dMWEDeftnc8Db0C7DtnVGjmc='; style-src 'unsafe-inline'; img-src 'self'; base-uri 'none'; form-action 'self'; frame-ancestors 'none'`,
          },
          { key: "Cross-Origin-Resource-Policy", value: "same-origin" },
