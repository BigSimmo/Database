...
-- ============================================================
-- 5. OTHER EXPECTED SCHEMA INDEXES FROM OTHER MIGRATIONS
-- ============================================================
create index if not exists ingestion_jobs_status_next_run_idx
  on public.ingestion_jobs(status, next_run_at asc)
  where status in ('pending', 'processing');

create index if not exists ingestion_jobs_document_status_idx
  on public.ingestion_jobs(document_id, status);
...
create index if not exists storage_cleanup_jobs_status_created_idx
  on public.storage_cleanup_jobs(status, created_at desc);

-- ============================================================
-- 6. ENHANCED HYBRID SCORING
-- ============================================================
...
-- Update health check with correct indexes
